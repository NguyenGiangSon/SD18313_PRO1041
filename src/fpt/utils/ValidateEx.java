...
import fpt.utils.Contants.Validates;
...
public class ValidateEx {
    ...
    public static String checkIsNullWithLengt(JTextComponent jTextField, JLabel jLabel, int maxLengt) throws Exception {
        if (jTextField.getText().isBlank()) {
            throw new Exception(String.format(Validates.NO_EMTY.getTen(), jLabel.getText()));
        } else if (maxLengt > 0) {
            if (jTextField.getText().length() > maxLengt) {
                throw new Exception(String.format(Validates.NO_EMTY.getTen(), jLabel.getText(), maxLengt));
            }
        }
    ...
    public static String checkIsNumF(JTextField jTextField, JLabel jLabel) throws Exception {
        ...
        try {
            ...
            throw new Exception(String.format(Validates.IS_NUMS.getTen(), jLabel.getText()));
        }
        return result;
    }
    ...
    public static String checkMoreThan(JTextField jTextField, JLabel jLabel, int valueCheck) throws Exception {
        ...
        if (a < valueCheck) {
            throw new Exception(String.format(Validates.PHAI_LON_HON.getTen(), jLabel.getText(), valueCheck));
        }
        return result;
    }
    ...
    public static <T> T convert(String input, Class<T> clazzType) throws Exception {
        try {
            ...
            throw new Exception(String.format(Validates.CONVERT_FAILED.getTen(), clazzType.getName()));
        }
    }
    ...
    public static Date checkIsDate(JTextComponent jTextField, JLabel jLabel) throws Exception {
        ...
        if (jTextField.getText().isBlank()) {
            ...
            try {
                ...
                throw new Exception(String.format(Validates.CHECK_DATE_DD_MM_YYYY.getTen(), jLabel.getText()));
            }
        }
