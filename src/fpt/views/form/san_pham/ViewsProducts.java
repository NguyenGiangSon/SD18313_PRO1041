    ...
    public ViewsProducts() {
        ...
        TableActionEvent actionEvent = new TableActionEvent() {
            ...
            public void onEdit(int row) {
                onViewAddEdit(MODEL_VIEW.SUA, tableModel.getValueAt(row, 1) + "", tableModel.getValueAt(row, 2) + "");
            }
...
//                    ViewsProductDto obj = viewsProductDao.getById2(tableModel.getValueAt(row, 1) + "");
                    String maSp = tableModel.getValueAt(row, 1).toString();
                    if (maSp.equals(tableModel.getValueAt(row, 2))) {
                        viewsProductDao.updateStatusProductCt(maSp);
                    } else {
                        viewsProductDao.deleteProductCt(tableModel.getValueAt(row, 2) + "");
                    }
            ...
            public void onView(int row) {
                onViewAddEdit(MODEL_VIEW.CHI_TIET, tableModel.getValueAt(row, 1) + "", tableModel.getValueAt(row, 2) + "");
            }
        };
        table.setRowHeight(35);
        table.getColumnModel().getColumn(9).setCellRenderer(new TableActionCellRender());
        table.getColumnModel().getColumn(9).setCellEditor(new TabelActionCellEditor(actionEvent));
    ...
    private void initComponents() {
        ...
        btnAddSpct = new fpt.views.swing.my.MyButton();
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã SP", "Mã SP CT", "Tên SP", "Giá", "Danh mục", "Nhà SX", "Kích cỡ", "Màu sắc", "Thao tác"
            }
        ) {
        ...
        btnAddSpct.setText("Thêm mới chi tiết");
        btnAddSpct.setPreferredSize(new java.awt.Dimension(84, 25));
            ...
            .addGroup(panelBorder1Layout.createSequentialGroup()
                ...
                .addGroup(panelBorder1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelBorder1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnAddSpct, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        panelBorder1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelBorder1Layout.createSequentialGroup()
                ...
                .addGroup(panelBorder1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnAddSpct, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//        onViewAddEdit(MODEL_VIEW.THEM_MOI, null);
    ...
    private fpt.views.swing.my.MyButton btnAddSpct;
...
//    }
    private void fillTable(ViewsProductDto object) {
        ...
        for (ViewsProductDto s : lstSp) {
            tableModel.addRow(new Object[]{
                ++index, s.getMaSanPham(), s.getMaSanPhamCt(), s.getTenSP(), s.getGiaBan(), s.getDanhMucText(), s.getNhaSxText(), s.getKichCoText(), s.getMauSacText()
            });
        }
    }
    ...
    private void openModelAdd() {
        AddProductDialog addProductDialog = new AddProductDialog(MODEL_VIEW.THEM_MOI, null, this);
        jDialog = new JDialog();
        jDialog.setModalityType(Dialog.ModalityType.APPLICATION_MODAL);
        jDialog.setSize(680, 500);
    ...
    private void onViewAddEdit(MODEL_VIEW model_view, String maSp, String maSpCt) {
        AddDetailProductDialog dialog;
        switch (model_view) {
            case SUA:
                dialog = new AddDetailProductDialog(model_view, maSp, maSpCt, this);
                break;
            case CHI_TIET:
                dialog = new AddDetailProductDialog(model_view, maSp, maSpCt, this);
                break;
    ...
    private void addNewSpCt() {
        int index = table.getSelectedRow();
        String maSp = "";
        if (index < 0) {
            maSp = MsgBox.prompt(this, "Nhập mã sản phẩm muốn thêm!");
        } else {
            maSp = tableModel.getValueAt(index, 1).toString();
        }
        ViewsProductDto obj = viewsProductDao.getById2(maSp);
        if (obj == null) {
            MsgBox.alert(this, "Sản phẩm có mã " + maSp + " không tồn tại");
            return;
        }

        AddDetailProductDialog addProductDialog;
        addProductDialog = new AddDetailProductDialog(MODEL_VIEW.THEM_MOI_CT, obj.getMaSanPham(), null, this);
        jDialog = new JDialog();
        jDialog.setModalityType(Dialog.ModalityType.APPLICATION_MODAL);
        jDialog.setSize(680, 540);
        jDialog.setResizable(false);
