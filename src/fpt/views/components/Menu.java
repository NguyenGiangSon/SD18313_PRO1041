...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new ModelMenu("buying-25", "Bán hàng", ModelMenu.MenuType.MENU));
        listMenu1.addItem(new ModelMenu("buying-25", "Bán hàng Demo", ModelMenu.MenuType.MENU));
